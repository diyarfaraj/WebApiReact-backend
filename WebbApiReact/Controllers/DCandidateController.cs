...
namespace WebbApiReact.Controllers
{
    ...
    public class DCandidateController : ControllerBase
    {
        ...
        // GET: api/DCandidate
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DCandidate>>> GetDbCandidate()
        {
            return await _context.DbCandidate.ToListAsync();
        }
        ...
        {
            var dCandidate = await _context.DbCandidate.FindAsync(id);
        ...
        {
            _context.DbCandidate.Add(dCandidate);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<DCandidate>> DeleteDCandidate(int id)
        {
            ...
            _context.DbCandidate.Remove(dCandidate);
            await _context.SaveChangesAsync();

            return dCandidate;
        }

        //method to check for DCandidates
        private bool DCandidateExists(int id)
        {
            return _context.DbCandidate.Any(e => e.Id == id);
        }
    }
}
